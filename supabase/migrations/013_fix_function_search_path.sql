-- Fix function search_path mutability warnings
-- This addresses the Supabase linter warnings about functions with mutable search_path
...
-- Fix sync_notes_simple function
...
-- Fix check_ai_usage function (if it exists)
